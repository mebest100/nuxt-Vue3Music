...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/h3/dist/index.mjs';
import axios from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/axios/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/devalue/index.js';
import { renderToString } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/ofetch/dist/node.mjs';
import destr from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/scule/dist/index.mjs';
import { klona } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/radix3/dist/index.mjs';
import { createProxyEventHandler } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/h3-proxy/lib/index.esm.js';
import { version, unref } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\CodeTest\\Vue3-Learning\\nuxt-Vue3Music","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"F:\\CodeTest\\Vue3-Learning\\nuxt-Vue3Music\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\CodeTest\\Vue3-Learning\\nuxt-Vue3Music\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"F:\\CodeTest\\Vue3-Learning\\nuxt-Vue3Music\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"F:\\CodeTest\\Vue3-Learning\\nuxt-Vue3Music\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _jGOSq7lFKf = (function(nitro) {
...
const buildtimeOptions$1 = {"target":"http://127.0.0.1:3600","pathFilter":["/api"]};

        const runtimeOptions$1 = [].concat(useRuntimeConfig().proxy?.options)[0 ];
    
        const _MLB01a = createProxyMiddleware(defu$1(runtimeOptions$1, buildtimeOptions$1));

const buildtimeOptions = {"target":"https://api.vvhan.com/api/joke","pathRewrite":{"^/getjoke":""},"pathFilter":["/getjoke"]};

        const runtimeOptions = [].concat(useRuntimeConfig().proxy?.options)[1 ];
    
        const _Ak7d5g = createProxyMiddleware(defu$1(runtimeOptions, buildtimeOptions));

const _lazy_lG5JQK = () => Promise.resolve().then(function () { return getinfo$1; });
const _lazy_HUoDPd = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/getinfo', handler: _lazy_lG5JQK, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_HUoDPd, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _MLB01a, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _Ak7d5g, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_HUoDPd, lazy: true, middleware: false, method: undefined }
];
...
const getinfo = defineEventHandler(() => {
...
const getinfo$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getinfo
});
...
const getClientManifest = () => import('file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://F:/CodeTest/Vue3-Learning/nuxt-Vue3Music/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
